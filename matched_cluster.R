...
# folder should be the high level folder containing the output of FulQuant
# THe folder that contains fastq folder, aligments
folder = args[1]
...
library(ggplot2)
# Takes in the df generated by merge_tables, and the number of samples in the comparison
